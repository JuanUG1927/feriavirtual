 ...
 */
# $settings['config_exclude_modules'] = ['devel', 'stage_file_proxy'];assert_options(ASSERT_ACTIVE, TRUE);
\Drupal\Component\Assertion\Handle::register();
...
$settings['seed_website_chat_disabled'] = TRUE;
$settings['movilexito_rechpack_recaptcha'] = FALSE;